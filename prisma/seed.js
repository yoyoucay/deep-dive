...
const newsData = [
  ...
  },
  {
    ...
    date: "2025-11-15",
    content:
      "Scientists have achieved a breakthrough in quantum computing that could revolutionize technology as we know it. The new quantum processor demonstrates unprecedented stability and computational power, bringing us closer to solving complex problems in medicine, climate science, and cryptography.",
  },
  {
    ...
    date: "2025-12-20",
    content:
      "Urban planners worldwide are implementing innovative green technologies to create sustainable cities. From vertical farms to solar-powered infrastructure, these initiatives are transforming how we live and interact with our environment.",
  },
  {
    ...
    date: "2025-10-05",
    content:
      "The global ocean cleanup project has successfully removed over 100,000 tons of plastic waste from the Pacific Ocean. This milestone marks a significant step forward in addressing marine pollution and protecting ocean ecosystems.",
  },
  {
    ...
    date: "2025-09-12",
    content:
      "Private space companies announce new affordable packages for space tourism, making trips to the edge of space accessible to more people than ever before. The democratization of space travel is finally becoming a reality.",
  },
  {
    ...
    date: "2026-01-03",
    content:
      "Artificial intelligence systems are now detecting diseases earlier and more accurately than traditional methods. Hospitals worldwide are adopting AI-powered diagnostic tools that are saving lives and reducing healthcare costs.",
  },
];
...
async function main() {
  ...
  console.log(`✅ Successfully seeded ${count} news articles!`);
}
